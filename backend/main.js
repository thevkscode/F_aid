const indicators = require("technicalindicators"); //this is used to get the rsi values
...
module.exports = function main(date) {
  ...
  while (i < 50) {
    ...
    while (j < 50) {
      let pair1 = Stocks[i];
      let pair2 = Stocks[j];
      let closingPrice1 = pair1.CLOSE.slice(
        index.startIndex,
        index.endIndex + 1
      );
      let closingPrice2 = pair2.CLOSE.slice(
        index.startIndex,
        index.endIndex + 1
      );
